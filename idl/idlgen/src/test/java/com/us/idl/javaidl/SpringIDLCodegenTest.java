 ...
 *
 */
public class SpringIDLCodegenTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              ...
              .setOutputDir("out/spring-idl"); // output directory
  ...
  public void insertDependencies(){
    ...
    SpringIDLCodegen codegen = new SpringIDLCodegen();
  ...
  public void noDependencies(){
    OpenAPI openAPI = new OpenAPIParser().readLocation("exampleNoIDL.yaml", null, new ParseOptions()).getOpenAPI();
    SpringIDLCodegen codegen = new SpringIDLCodegen();
  ...
  public void testGeneratedFiles() throws Exception{
    ...
    Assert.assertEquals(194, files.size());

    Path path = output.toPath().resolve("src/main/java/org/openapitools/api/DependencyUtil.java");

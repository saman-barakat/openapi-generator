 ...
 *
 */
public class JavaIDLCodegenTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("java-idl") // use this codegen library
              .setInputSpec("youtubeIDL.yaml") // sample OpenAPI file
              // .setInputSpec("https://raw.githubusercontent.com/openapitools/openapi-generator/master/modules/openapi-generator/src/test/resources/2_0/petstore.yaml") // or from the server
              .setOutputDir("out/java-idl"); // output directory
  ...
  public void testGeneratedFiles() throws Exception{
    ...
    Assert.assertEquals(585, files.size());

    Path path = output.toPath().resolve("src/main/java/org/openapitools/client/DependencyUtil.java");

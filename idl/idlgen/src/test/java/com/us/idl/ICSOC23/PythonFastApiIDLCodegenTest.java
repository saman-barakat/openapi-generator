 ...
 *
 */
public class PythonFastApiIDLCodegenTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              ...
              .setOutputDir("out/ICSOC23/Python/youtubeIDL"); // output directory
  ...
  public void launchCodeGeneratorAmadeus() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
            ...
            .setOutputDir("out/ICSOC23/Python/AmadeusIDL"); // output directory
  ...
  public void launchCodeGeneratorDHL() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
            ...
            .setOutputDir("out/ICSOC23/Python/DHLIDL"); // output directory
  ...
  public void launchCodeGeneratorFoursquare() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
            ...
            .setOutputDir("out/ICSOC23/Python/FoursquareIDL"); // output directory
  ...
  public void launchCodeGeneratorOhsome() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
            ...
            .setOutputDir("out/ICSOC23/Python/OhsomeIDL"); // output directory
  ...
  public void launchCodeGeneratorOMDb() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
            ...
            .setOutputDir("out/ICSOC23/Python/OMDbIDL"); // output directory
  ...
  public void launchCodeGeneratorTravel() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
            ...
            .setOutputDir("out/ICSOC23/Python/TravelIDL"); // output directory
  ...
  public void launchCodeGeneratorTumblr() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
            ...
            .setOutputDir("out/ICSOC23/Python/TumblrIDL"); // output directory
  ...
  public void launchCodeGeneratorYelp() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
            ...
            .setOutputDir("out/ICSOC23/Python/YelpIDL"); // output directory
